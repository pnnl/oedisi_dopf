...
def _solve_lindist_OPF(branch_sw_data_case, bus_info, kw_converter, source_bus, source_bus_idx, vsrc, pf_flag, solver_name,
                       P_control=True, Q_control=False, print_LineFlows_Voltage=False, print_result=True, primary_kv_level=0.01):
