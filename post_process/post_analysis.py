...
# voltage_mag = feather.read_feather(
#     os.path.join(args.directory, "voltage_mag.feather"))
...
#         MAPE, MAE = errors(
#             true_voltages.iloc[i, :], estimated_voltages.iloc[i, :])
...
#     ax.set_xticks(err_table["t"][::5], err_table["t"]
#                   [::5], rotation=-25, fontsize=5)
#     return fig
...
#     unit="p.u.",
# )
# fig1.savefig(os.path.join(args.directory, "voltage_angles_0.png"))
# fig2.savefig(os.path.join(args.directory, "voltage_magnitudes_0.png"))
...
#         unit="p.u.",
#     )
#     fig1.savefig(os.path.join(args.directory, "voltage_angles_95.png"))
#     fig2.savefig(os.path.join(args.directory, "voltage_magnitudes_95.png"))
