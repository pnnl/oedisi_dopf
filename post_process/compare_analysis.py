...
def plot_result_comparison(
        casename1, casename2, time, 
        coordsys="2D", root = "150", 
        ymin = 0.98, ymax = 1.06, 
        seperator = "    ", annotate=True
        ):
    ...
    plotter.compare_vtree(
        ...
        sep = seperator, root_node = root,
        coordsys = coordsys, time = time,
        to_file = fig_filename1, show=False, do_return=False,
        lw=2.5, ls='dashed', 
        figsize=(40,18), annotate=annotate,
        ymin = ymin, ymax = ymax, 
        )
    ...
    plotter.compare_network(
        ...
        sep = seperator, root_node = root,
        coordsys = coordsys, time = time,
        to_file = fig_filename2, show=False, do_return=False,
        vmin=1.0, vmax=1.05,
        )
